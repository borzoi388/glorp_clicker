...
{#if visible}
    <div class="w-full p-2 text-blue-800 px-2 py-1">
        ...
        <div onclick={buy} class="grid grid-cols-5 items-stretch border border-2 border-blue-800 {!faded ? "-translate-[2px] shadow-[2px_2px_0px_0px_var(--color-blue-800)] bg-rose-200" : "bg-rose-200/50"} {isPressed ? "shadow-[inset_1px_1px_0px_0px_var(--color-blue-800)] translate-0 p-[5px_1px_3px_1px]" : "py-[4px]"}">
